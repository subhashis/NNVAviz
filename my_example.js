...
function drawBrush() {
  ...
  function brush() {
    ...
    if (start < end) {
      ...
      earlyMin = d3.min(filteredDataEarly, function (d) {
        return d.index
      })
      ...
      function beforeBars(bars) {
        return bars.filter(function (d) {
          ...
          return {
            startInt: d.startInt - earlyMin,
            endInt: d.endInt - earlyMin,
            category: d.category
          }
        })
      }
      ...
      function afterBars(bars) {
        return bars.filter(function (d) {
          ...
          return {
            startInt: d.startInt + barOffset,
            endInt: d.endInt + barOffset,
            category: d.category
          }
        })
      }
    ...
    minDate = d3.min(filteredData, function (d) {
      return d.index
    })
    maxDate = d3.max(filteredData, function (d) {
      return d.index
    })
    ...
    d3.select("g.linear")
      ...
      .attr("y", -10)
      .attr("x", function (d) {
        return xScale((d.startInt - minDate))
      })
      .attr("width", function (d) {
        return Math.min(250 - xScale((d.startInt - minDate)), (d.endInt - d.startInt) * lineWidth)
      })
      .attr("height", "5px")
